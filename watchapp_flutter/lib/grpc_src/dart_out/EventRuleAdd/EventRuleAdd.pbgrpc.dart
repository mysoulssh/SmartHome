...
library EventRuleAdd_EventRuleAdd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'EventRuleAdd.pb.dart';
export 'EventRuleAdd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/EventRuleAdd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'EventRuleAdd.RpcYCall';
