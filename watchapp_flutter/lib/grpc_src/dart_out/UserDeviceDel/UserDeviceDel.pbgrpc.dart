...
library UserDeviceDel_UserDeviceDel_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceDel.pb.dart';
export 'UserDeviceDel.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceDel.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceDel.RpcYCall';
