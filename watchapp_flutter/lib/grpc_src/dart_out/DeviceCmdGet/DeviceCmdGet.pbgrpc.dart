...
library DeviceCmdGet_DeviceCmdGet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceCmdGet.pb.dart';
export 'DeviceCmdGet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceCmdGet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceCmdGet.RpcYCall';
