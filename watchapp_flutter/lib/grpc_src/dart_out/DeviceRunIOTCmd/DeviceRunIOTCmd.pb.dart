...
library DeviceRunIOTCmd_DeviceRunIOTCmd;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<IOTCMD>(11, 'cmd', PbFieldType.OM, IOTCMD.getDefault, IOTCMD.create)
  ...
  IOTCMD get cmd => $_get(1, 11, null);
  set cmd(IOTCMD v) { setField(11, v); }
  bool hasCmd() => $_has(1, 11);
  void clearCmd() => clearField(11);
}
