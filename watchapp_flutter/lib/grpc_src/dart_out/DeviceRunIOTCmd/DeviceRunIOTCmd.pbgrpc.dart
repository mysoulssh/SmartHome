...
library DeviceRunIOTCmd_DeviceRunIOTCmd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceRunIOTCmd.pb.dart';
export 'DeviceRunIOTCmd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceRunIOTCmd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceRunIOTCmd.RpcYCall';
