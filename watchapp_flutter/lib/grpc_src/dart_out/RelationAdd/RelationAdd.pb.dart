...
library RelationAdd_RelationAdd;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<int>(11, 'relationCode', PbFieldType.OU3)
    ..a<String>(12, 'relationDesc', PbFieldType.OS)
  ...
  int get relationCode => $_get(1, 11, 0);
  set relationCode(int v) { $_setUnsignedInt32(1, 11, v); }
  bool hasRelationCode() => $_has(1, 11);
  void clearRelationCode() => clearField(11);

  String get relationDesc => $_get(2, 12, '');
  set relationDesc(String v) { $_setString(2, 12, v); }
  bool hasRelationDesc() => $_has(2, 12);
  void clearRelationDesc() => clearField(12);
}
