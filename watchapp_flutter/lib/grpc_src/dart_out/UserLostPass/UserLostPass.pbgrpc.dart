...
library UserLostPass_UserLostPass_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserLostPass.pb.dart';
export 'UserLostPass.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserLostPass.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserLostPass.RpcYCall';
