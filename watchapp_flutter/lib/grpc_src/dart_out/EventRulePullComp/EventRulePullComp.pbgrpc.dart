...
library EventRulePullComp_EventRulePullComp_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'EventRulePullComp.pb.dart';
export 'EventRulePullComp.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/EventRulePullComp.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'EventRulePullComp.RpcYCall';
