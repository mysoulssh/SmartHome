...
library UserDeviceShareListByOwner_UserDeviceShareListByOwner_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceShareListByOwner.pb.dart';
export 'UserDeviceShareListByOwner.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceShareListByOwner.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceShareListByOwner.RpcYCall';
