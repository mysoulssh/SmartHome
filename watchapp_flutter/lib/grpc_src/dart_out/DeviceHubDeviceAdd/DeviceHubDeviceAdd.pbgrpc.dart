...
library DeviceHubDeviceAdd_DeviceHubDeviceAdd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceHubDeviceAdd.pb.dart';
export 'DeviceHubDeviceAdd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceHubDeviceAdd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceHubDeviceAdd.RpcYCall';
