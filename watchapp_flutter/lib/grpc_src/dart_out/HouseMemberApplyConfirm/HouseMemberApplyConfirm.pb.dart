...
library HouseMemberApplyConfirm_HouseMemberApplyConfirm;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<int>(12, 'userId', PbFieldType.OU3)
    ..a<int>(13, 'action', PbFieldType.O3)
  ...
  int get userId => $_get(2, 12, 0);
  set userId(int v) { $_setUnsignedInt32(2, 12, v); }
  bool hasUserId() => $_has(2, 12);
  void clearUserId() => clearField(12);

  int get action => $_get(3, 13, 0);
  set action(int v) { $_setUnsignedInt32(3, 13, v); }
  bool hasAction() => $_has(3, 13);
