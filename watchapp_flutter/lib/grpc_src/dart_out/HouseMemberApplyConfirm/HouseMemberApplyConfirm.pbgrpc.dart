...
library HouseMemberApplyConfirm_HouseMemberApplyConfirm_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseMemberApplyConfirm.pb.dart';
export 'HouseMemberApplyConfirm.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseMemberApplyConfirm.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseMemberApplyConfirm.RpcYCall';
