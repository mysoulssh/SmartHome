...
library DeviceRomDel_DeviceRomDel_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceRomDel.pb.dart';
export 'DeviceRomDel.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceRomDel.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceRomDel.RpcYCall';
