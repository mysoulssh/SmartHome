...
library UserDeviceUseDel_UserDeviceUseDel_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceUseDel.pb.dart';
export 'UserDeviceUseDel.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceUseDel.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceUseDel.RpcYCall';
