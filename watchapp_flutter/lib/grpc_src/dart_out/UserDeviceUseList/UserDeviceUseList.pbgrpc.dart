...
library UserDeviceUseList_UserDeviceUseList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceUseList.pb.dart';
export 'UserDeviceUseList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceUseList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceUseList.RpcYCall';
