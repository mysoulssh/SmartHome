...
library UserDeviceUseList_UserDeviceUseList_pbjson;
...
const RpcRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'use_user_id', '3': 21, '4': 1, '5': 13, '10': 'useUserId'},
  ],
};
...
const RpcResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'uses', '3': 2, '4': 3, '5': 11, '6': '.UserDeviceUseList.UseInfo', '10': 'uses'},
  ],
};
