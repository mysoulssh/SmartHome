...
library HouseMemberQuit_HouseMemberQuit_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseMemberQuit.pb.dart';
export 'HouseMemberQuit.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseMemberQuit.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseMemberQuit.RpcYCall';
