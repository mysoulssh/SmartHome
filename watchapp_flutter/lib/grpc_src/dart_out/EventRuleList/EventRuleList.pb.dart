...
library EventRuleList_EventRuleList;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(23, 'houseGuid', PbFieldType.OS)
  ...
  String get houseGuid => $_get(3, 23, '');
  set houseGuid(String v) { $_setString(3, 23, v); }
  bool hasHouseGuid() => $_has(3, 23);
  void clearHouseGuid() => clearField(23);
}
