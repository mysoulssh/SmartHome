...
library DeviceCmdLast_DeviceCmdLast;
...
class RpcRequest extends GeneratedMessage {
  ...
  String get deviceId => $_get(1, 21, '');
  set deviceId(String v) { $_setString(1, 21, v); }
  bool hasDeviceId() => $_has(1, 21);
  void clearDeviceId() => clearField(21);

  String get subDeviceId => $_get(2, 22, '');
  set subDeviceId(String v) { $_setString(2, 22, v); }
  bool hasSubDeviceId() => $_has(2, 22);
...
class RpcResponse extends GeneratedMessage {
  ...
  List<CmdRecord> get cmds => $_get(0, 11, null);
}
