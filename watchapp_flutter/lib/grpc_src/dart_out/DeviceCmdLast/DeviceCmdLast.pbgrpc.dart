...
library DeviceCmdLast_DeviceCmdLast_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceCmdLast.pb.dart';
export 'DeviceCmdLast.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceCmdLast.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceCmdLast.RpcYCall';
