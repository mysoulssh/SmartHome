...
library HouseAreaDel_HouseAreaDel_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseAreaDel.pb.dart';
export 'HouseAreaDel.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseAreaDel.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseAreaDel.RpcYCall';
