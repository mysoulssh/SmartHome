...
library UserDeviceShareList_UserDeviceShareList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceShareList.pb.dart';
export 'UserDeviceShareList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceShareList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceShareList.RpcYCall';
