...
library UserDeviceUseAdd_UserDeviceUseAdd;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<int>(12, 'useUserId', PbFieldType.OU3)
  ...
  int get useUserId => $_get(2, 12, 0);
  set useUserId(int v) { $_setUnsignedInt32(2, 12, v); }
  bool hasUseUserId() => $_has(2, 12);
  void clearUseUserId() => clearField(12);
}
