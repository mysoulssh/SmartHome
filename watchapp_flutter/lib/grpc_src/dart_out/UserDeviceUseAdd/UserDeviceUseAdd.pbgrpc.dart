...
library UserDeviceUseAdd_UserDeviceUseAdd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceUseAdd.pb.dart';
export 'UserDeviceUseAdd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceUseAdd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceUseAdd.RpcYCall';
