...
library UserDeviceUseListByOwner_UserDeviceUseListByOwner;
...
class UseInfo extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UseInfo')
    ...
    ..a<int>(2, 'useUserId', PbFieldType.OU3)
  ...
  int get useUserId => $_get(1, 2, 0);
  set useUserId(int v) { $_setUnsignedInt32(1, 2, v); }
  bool hasUseUserId() => $_has(1, 2);
  void clearUseUserId() => clearField(2);
