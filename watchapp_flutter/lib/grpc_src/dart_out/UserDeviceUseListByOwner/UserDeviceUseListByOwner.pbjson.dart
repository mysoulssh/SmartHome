...
library UserDeviceUseListByOwner_UserDeviceUseListByOwner_pbjson;

const UseInfo$json = const {
  '1': 'UseInfo',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 13, '10': 'userId'},
    const {'1': 'use_user_id', '3': 2, '4': 1, '5': 13, '10': 'useUserId'},
...
const RpcResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'uses', '3': 2, '4': 3, '5': 11, '6': '.UserDeviceUseListByOwner.UseInfo', '10': 'uses'},
  ],
};
