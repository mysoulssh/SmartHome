...
library UserDeviceUseListByOwner_UserDeviceUseListByOwner_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceUseListByOwner.pb.dart';
export 'UserDeviceUseListByOwner.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceUseListByOwner.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceUseListByOwner.RpcYCall';
