...
library UserRefreshToken_UserRefreshToken_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserRefreshToken.pb.dart';
export 'UserRefreshToken.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserRefreshToken.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserRefreshToken.RpcYCall';
