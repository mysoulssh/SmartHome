...
library DeviceFailcodeSet_DeviceFailcodeSet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceFailcodeSet.pb.dart';
export 'DeviceFailcodeSet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceFailcodeSet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceFailcodeSet.RpcYCall';
