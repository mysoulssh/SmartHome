...
library DeviceHubDeviceList_DeviceHubDeviceList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceHubDeviceList.pb.dart';
export 'DeviceHubDeviceList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceHubDeviceList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceHubDeviceList.RpcYCall';
