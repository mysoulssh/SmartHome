...
library CompanyReview_CompanyReview_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'CompanyReview.pb.dart';
export 'CompanyReview.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/CompanyReview.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'CompanyReview.RpcYCall';
