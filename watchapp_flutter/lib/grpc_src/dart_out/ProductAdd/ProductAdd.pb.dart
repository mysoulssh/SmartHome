...
class RpcRequest extends GeneratedMessage {
  ...
  String get productName => $_get(1, 11, '');
  set productName(String v) { $_setString(1, 11, v); }
  bool hasProductName() => $_has(1, 11);
  void clearProductName() => clearField(11);

  String get companyCode => $_get(2, 12, '');
  set companyCode(String v) { $_setString(2, 12, v); }
  bool hasCompanyCode() => $_has(2, 12);
  void clearCompanyCode() => clearField(12);

  String get pic1 => $_get(3, 13, '');
  set pic1(String v) { $_setString(3, 13, v); }
  bool hasPic1() => $_has(3, 13);
  void clearPic1() => clearField(13);

  String get pic2 => $_get(4, 14, '');
  set pic2(String v) { $_setString(4, 14, v); }
  bool hasPic2() => $_has(4, 14);
  void clearPic2() => clearField(14);

  String get remark => $_get(5, 15, '');
  set remark(String v) { $_setString(5, 15, v); }
  bool hasRemark() => $_has(5, 15);
  void clearRemark() => clearField(15);

  List<String> get nbiCode => $_get(6, 16, null);

  List<String> get prodtCode => $_get(7, 17, null);
}
