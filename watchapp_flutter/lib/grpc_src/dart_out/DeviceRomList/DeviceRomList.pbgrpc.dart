...
library DeviceRomList_DeviceRomList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceRomList.pb.dart';
export 'DeviceRomList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceRomList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceRomList.RpcYCall';
