...
library EventRulePull_EventRulePull_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'EventRulePull.pb.dart';
export 'EventRulePull.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/EventRulePull.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'EventRulePull.RpcYCall';
