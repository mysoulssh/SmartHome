...
library HouseMemberInvite_HouseMemberInvite_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseMemberInvite.pb.dart';
export 'HouseMemberInvite.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseMemberInvite.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseMemberInvite.RpcYCall';
