...
library HouseMemberInvite_HouseMemberInvite;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<int>(12, 'inviteUserId', PbFieldType.OU3)
  ...
  int get inviteUserId => $_get(2, 12, 0);
  set inviteUserId(int v) { $_setUnsignedInt32(2, 12, v); }
  bool hasInviteUserId() => $_has(2, 12);
  void clearInviteUserId() => clearField(12);
}
