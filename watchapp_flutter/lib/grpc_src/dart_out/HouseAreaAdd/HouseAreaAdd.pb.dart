...
library HouseAreaAdd_HouseAreaAdd;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(12, 'areaName', PbFieldType.OS)
  ...
  String get areaName => $_get(2, 12, '');
  set areaName(String v) { $_setString(2, 12, v); }
  bool hasAreaName() => $_has(2, 12);
  void clearAreaName() => clearField(12);
}
...
class RpcResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcResponse')
    ..a<String>(11, 'areaGuid', PbFieldType.OS)
    ..hasRequiredFields = false
  ;
  ...
  String get areaGuid => $_get(0, 11, '');
  set areaGuid(String v) { $_setString(0, 11, v); }
  bool hasAreaGuid() => $_has(0, 11);
  void clearAreaGuid() => clearField(11);
}
