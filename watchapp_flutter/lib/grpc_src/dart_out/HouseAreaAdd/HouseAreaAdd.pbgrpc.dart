...
library HouseAreaAdd_HouseAreaAdd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseAreaAdd.pb.dart';
export 'HouseAreaAdd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseAreaAdd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseAreaAdd.RpcYCall';
