...
library ProductCmdList_ProductCmdList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'ProductCmdList.pb.dart';
export 'ProductCmdList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/ProductCmdList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'ProductCmdList.RpcYCall';
