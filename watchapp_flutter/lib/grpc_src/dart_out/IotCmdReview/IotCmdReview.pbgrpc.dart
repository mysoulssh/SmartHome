...
library IotCmdReview_IotCmdReview_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'IotCmdReview.pb.dart';
export 'IotCmdReview.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/IotCmdReview.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'IotCmdReview.RpcYCall';
