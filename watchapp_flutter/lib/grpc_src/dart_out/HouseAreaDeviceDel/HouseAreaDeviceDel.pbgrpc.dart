...
library HouseAreaDeviceDel_HouseAreaDeviceDel_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseAreaDeviceDel.pb.dart';
export 'HouseAreaDeviceDel.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseAreaDeviceDel.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseAreaDeviceDel.RpcYCall';
