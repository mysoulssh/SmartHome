...
library HouseAreaDeviceSet_HouseAreaDeviceSet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseAreaDeviceSet.pb.dart';
export 'HouseAreaDeviceSet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseAreaDeviceSet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseAreaDeviceSet.RpcYCall';
