...
library UserDeviceAdd_UserDeviceAdd;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(12, 'deviceName', PbFieldType.OS)
  ...
  String get deviceName => $_get(2, 12, '');
  set deviceName(String v) { $_setString(2, 12, v); }
  bool hasDeviceName() => $_has(2, 12);
  void clearDeviceName() => clearField(12);
}
