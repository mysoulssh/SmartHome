...
library UserDeviceAdd_UserDeviceAdd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceAdd.pb.dart';
export 'UserDeviceAdd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceAdd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceAdd.RpcYCall';
