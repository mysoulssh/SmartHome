...
library DeviceVerSet_DeviceVerSet;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<int>(11, 'swVer', PbFieldType.O3)
    ..a<int>(12, 'hwVer', PbFieldType.O3)
  ...
  int get swVer => $_get(3, 11, 0);
  set swVer(int v) { $_setUnsignedInt32(3, 11, v); }
  bool hasSwVer() => $_has(3, 11);
  void clearSwVer() => clearField(11);

  int get hwVer => $_get(4, 12, 0);
  set hwVer(int v) { $_setUnsignedInt32(4, 12, v); }
  bool hasHwVer() => $_has(4, 12);
  void clearHwVer() => clearField(12);
}
