...
library DeviceVerSet_DeviceVerSet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceVerSet.pb.dart';
export 'DeviceVerSet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceVerSet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceVerSet.RpcYCall';
