...
library DeviceStatusGet_DeviceStatusGet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceStatusGet.pb.dart';
export 'DeviceStatusGet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceStatusGet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceStatusGet.RpcYCall';
