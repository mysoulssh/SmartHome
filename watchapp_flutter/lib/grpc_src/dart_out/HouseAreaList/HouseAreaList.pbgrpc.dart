...
library HouseAreaList_HouseAreaList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseAreaList.pb.dart';
export 'HouseAreaList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseAreaList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseAreaList.RpcYCall';
