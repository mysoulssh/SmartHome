...
library DeviceHubDeviceDel_DeviceHubDeviceDel_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceHubDeviceDel.pb.dart';
export 'DeviceHubDeviceDel.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceHubDeviceDel.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceHubDeviceDel.RpcYCall';
