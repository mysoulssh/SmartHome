...
library UserDeviceList_UserDeviceList_pbjson;
...
const DeviceInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'create_time', '3': 3, '4': 1, '5': 13, '10': 'createTime'},
  ],
};
...
const RpcResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'devs', '3': 2, '4': 3, '5': 11, '6': '.UserDeviceList.DeviceInfo', '10': 'devs'},
  ],
};
