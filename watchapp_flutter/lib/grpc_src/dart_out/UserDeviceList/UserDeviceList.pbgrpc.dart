...
library UserDeviceList_UserDeviceList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceList.pb.dart';
export 'UserDeviceList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceList.RpcYCall';
