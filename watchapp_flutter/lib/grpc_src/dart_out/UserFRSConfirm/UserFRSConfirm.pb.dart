...
library UserFRSConfirm_UserFRSConfirm;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<int>(12, 'action', PbFieldType.OU3)
  ...
  int get action => $_get(2, 12, 0);
  set action(int v) { $_setUnsignedInt32(2, 12, v); }
  bool hasAction() => $_has(2, 12);
