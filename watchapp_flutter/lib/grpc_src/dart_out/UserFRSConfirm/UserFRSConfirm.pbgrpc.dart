...
library UserFRSConfirm_UserFRSConfirm_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserFRSConfirm.pb.dart';
export 'UserFRSConfirm.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserFRSConfirm.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserFRSConfirm.RpcYCall';
