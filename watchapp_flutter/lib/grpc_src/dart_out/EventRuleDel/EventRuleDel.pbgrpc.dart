...
library EventRuleDel_EventRuleDel_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'EventRuleDel.pb.dart';
export 'EventRuleDel.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/EventRuleDel.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'EventRuleDel.RpcYCall';
