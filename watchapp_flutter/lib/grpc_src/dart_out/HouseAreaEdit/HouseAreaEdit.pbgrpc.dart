...
library HouseAreaEdit_HouseAreaEdit_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseAreaEdit.pb.dart';
export 'HouseAreaEdit.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseAreaEdit.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseAreaEdit.RpcYCall';
