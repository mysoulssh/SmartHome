...
library HouseAreaEdit_HouseAreaEdit;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(12, 'areaGuid', PbFieldType.OS)
    ..a<String>(21, 'areaName', PbFieldType.OS)
  ...
  String get areaGuid => $_get(2, 12, '');
  set areaGuid(String v) { $_setString(2, 12, v); }
  bool hasAreaGuid() => $_has(2, 12);
  void clearAreaGuid() => clearField(12);

  String get areaName => $_get(3, 21, '');
  set areaName(String v) { $_setString(3, 21, v); }
  bool hasAreaName() => $_has(3, 21);
  void clearAreaName() => clearField(21);
}
