...
library UserDeviceEdit_UserDeviceEdit_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceEdit.pb.dart';
export 'UserDeviceEdit.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceEdit.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceEdit.RpcYCall';
