...
library UserDeviceEdit_UserDeviceEdit;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(21, 'deviceName', PbFieldType.OS)
  ...
  String get deviceName => $_get(2, 21, '');
  set deviceName(String v) { $_setString(2, 21, v); }
  bool hasDeviceName() => $_has(2, 21);
  void clearDeviceName() => clearField(21);
}
