...
library ProductCmdDel_ProductCmdDel_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'ProductCmdDel.pb.dart';
export 'ProductCmdDel.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/ProductCmdDel.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'ProductCmdDel.RpcYCall';
