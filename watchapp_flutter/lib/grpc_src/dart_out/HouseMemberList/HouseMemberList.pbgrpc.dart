...
library HouseMemberList_HouseMemberList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseMemberList.pb.dart';
export 'HouseMemberList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseMemberList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseMemberList.RpcYCall';
