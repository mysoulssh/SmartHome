...
library ScenePullComp_ScenePullComp_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'ScenePullComp.pb.dart';
export 'ScenePullComp.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/ScenePullComp.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'ScenePullComp.RpcYCall';
