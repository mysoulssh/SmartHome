...
library UserPhoneChange_UserPhoneChange_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserPhoneChange.pb.dart';
export 'UserPhoneChange.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserPhoneChange.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserPhoneChange.RpcYCall';
