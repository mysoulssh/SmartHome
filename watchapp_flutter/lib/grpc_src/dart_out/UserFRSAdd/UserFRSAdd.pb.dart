...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(11, 'relationUserName', PbFieldType.OS)
    ..a<int>(12, 'relationCode', PbFieldType.OU3)
  ...
  String get relationUserName => $_get(1, 11, '');
  set relationUserName(String v) { $_setString(1, 11, v); }
  bool hasRelationUserName() => $_has(1, 11);
  void clearRelationUserName() => clearField(11);

  int get relationCode => $_get(2, 12, 0);
  set relationCode(int v) { $_setUnsignedInt32(2, 12, v); }
  bool hasRelationCode() => $_has(2, 12);
  void clearRelationCode() => clearField(12);
}
