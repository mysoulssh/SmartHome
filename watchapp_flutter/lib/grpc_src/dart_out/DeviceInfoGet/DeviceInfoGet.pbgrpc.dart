...
library DeviceInfoGet_DeviceInfoGet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceInfoGet.pb.dart';
export 'DeviceInfoGet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceInfoGet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceInfoGet.RpcYCall';
