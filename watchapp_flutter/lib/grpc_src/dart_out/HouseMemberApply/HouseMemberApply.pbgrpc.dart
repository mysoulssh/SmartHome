...
library HouseMemberApply_HouseMemberApply_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseMemberApply.pb.dart';
export 'HouseMemberApply.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseMemberApply.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseMemberApply.RpcYCall';
