...
library DeviceHubDeviceName_DeviceHubDeviceName;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(13, 'deviceName', PbFieldType.OS)
  ...
  String get deviceName => $_get(3, 13, '');
  set deviceName(String v) { $_setString(3, 13, v); }
  bool hasDeviceName() => $_has(3, 13);
  void clearDeviceName() => clearField(13);
}
