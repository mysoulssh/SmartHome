...
library DeviceHubDeviceName_DeviceHubDeviceName_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceHubDeviceName.pb.dart';
export 'DeviceHubDeviceName.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceHubDeviceName.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceHubDeviceName.RpcYCall';
