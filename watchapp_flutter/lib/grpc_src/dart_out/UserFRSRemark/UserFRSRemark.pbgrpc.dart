...
library UserFRSRemark_UserFRSRemark_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserFRSRemark.pb.dart';
export 'UserFRSRemark.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserFRSRemark.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserFRSRemark.RpcYCall';
