...
library DeviceHubGetSubDevice_DeviceHubGetSubDevice_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceHubGetSubDevice.pb.dart';
export 'DeviceHubGetSubDevice.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceHubGetSubDevice.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceHubGetSubDevice.RpcYCall';
