...
library DeviceCmdAdd_DeviceCmdAdd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceCmdAdd.pb.dart';
export 'DeviceCmdAdd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceCmdAdd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceCmdAdd.RpcYCall';
