...
library EventRuleEdit_EventRuleEdit_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'EventRuleEdit.pb.dart';
export 'EventRuleEdit.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/EventRuleEdit.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'EventRuleEdit.RpcYCall';
