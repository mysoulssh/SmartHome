...
library UserDeviceShareDel_UserDeviceShareDel;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<int>(12, 'shareUserId', PbFieldType.OU3)
  ...
  int get shareUserId => $_get(2, 12, 0);
  set shareUserId(int v) { $_setUnsignedInt32(2, 12, v); }
  bool hasShareUserId() => $_has(2, 12);
  void clearShareUserId() => clearField(12);
}
