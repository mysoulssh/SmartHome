...
library UserDeviceShareDel_UserDeviceShareDel_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceShareDel.pb.dart';
export 'UserDeviceShareDel.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceShareDel.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceShareDel.RpcYCall';
