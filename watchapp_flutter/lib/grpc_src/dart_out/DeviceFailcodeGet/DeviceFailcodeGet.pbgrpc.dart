...
library DeviceFailcodeGet_DeviceFailcodeGet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceFailcodeGet.pb.dart';
export 'DeviceFailcodeGet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceFailcodeGet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceFailcodeGet.RpcYCall';
