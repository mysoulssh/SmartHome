...
library ProductReview_ProductReview_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'ProductReview.pb.dart';
export 'ProductReview.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/ProductReview.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'ProductReview.RpcYCall';
