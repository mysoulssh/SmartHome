...
library HouseDeviceList_HouseDeviceList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseDeviceList.pb.dart';
export 'HouseDeviceList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseDeviceList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseDeviceList.RpcYCall';
