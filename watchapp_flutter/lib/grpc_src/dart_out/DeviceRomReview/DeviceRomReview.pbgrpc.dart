...
library DeviceRomReview_DeviceRomReview_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceRomReview.pb.dart';
export 'DeviceRomReview.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceRomReview.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceRomReview.RpcYCall';
