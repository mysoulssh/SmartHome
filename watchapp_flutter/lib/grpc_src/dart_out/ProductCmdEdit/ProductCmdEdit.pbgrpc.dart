...
library ProductCmdEdit_ProductCmdEdit_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'ProductCmdEdit.pb.dart';
export 'ProductCmdEdit.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/ProductCmdEdit.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'ProductCmdEdit.RpcYCall';
