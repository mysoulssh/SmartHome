...
library DeviceStatusSet_DeviceStatusSet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceStatusSet.pb.dart';
export 'DeviceStatusSet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceStatusSet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceStatusSet.RpcYCall';
