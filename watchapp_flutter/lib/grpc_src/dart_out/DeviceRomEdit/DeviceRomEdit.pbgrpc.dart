...
library DeviceRomEdit_DeviceRomEdit_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceRomEdit.pb.dart';
export 'DeviceRomEdit.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceRomEdit.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceRomEdit.RpcYCall';
