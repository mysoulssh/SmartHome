...
library DeviceRomEdit_DeviceRomEdit;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(21, 'romMd5', PbFieldType.OS)
    ..a<String>(22, 'fileId', PbFieldType.OS)
    ..a<String>(23, 'changeLog', PbFieldType.OS)
  ...
  String get romMd5 => $_get(3, 21, '');
  set romMd5(String v) { $_setString(3, 21, v); }
  bool hasRomMd5() => $_has(3, 21);
  void clearRomMd5() => clearField(21);

  String get fileId => $_get(4, 22, '');
  set fileId(String v) { $_setString(4, 22, v); }
  bool hasFileId() => $_has(4, 22);
  void clearFileId() => clearField(22);

  String get changeLog => $_get(5, 23, '');
  set changeLog(String v) { $_setString(5, 23, v); }
  bool hasChangeLog() => $_has(5, 23);
  void clearChangeLog() => clearField(23);
}
