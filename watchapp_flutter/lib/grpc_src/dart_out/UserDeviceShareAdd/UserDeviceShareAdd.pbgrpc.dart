...
library UserDeviceShareAdd_UserDeviceShareAdd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserDeviceShareAdd.pb.dart';
export 'UserDeviceShareAdd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserDeviceShareAdd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserDeviceShareAdd.RpcYCall';
