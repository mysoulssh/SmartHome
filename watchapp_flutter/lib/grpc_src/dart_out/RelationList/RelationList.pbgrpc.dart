...
library RelationList_RelationList_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'RelationList.pb.dart';
export 'RelationList.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/RelationList.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'RelationList.RpcYCall';
