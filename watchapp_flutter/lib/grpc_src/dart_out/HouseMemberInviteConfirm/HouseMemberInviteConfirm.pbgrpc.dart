...
library HouseMemberInviteConfirm_HouseMemberInviteConfirm_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'HouseMemberInviteConfirm.pb.dart';
export 'HouseMemberInviteConfirm.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/HouseMemberInviteConfirm.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'HouseMemberInviteConfirm.RpcYCall';
