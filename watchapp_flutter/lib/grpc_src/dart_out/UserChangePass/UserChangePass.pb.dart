...
library UserChangePass_UserChangePass;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(11, 'password', PbFieldType.OS)
  ...
  String get password => $_get(1, 11, '');
  set password(String v) { $_setString(1, 11, v); }
  bool hasPassword() => $_has(1, 11);
