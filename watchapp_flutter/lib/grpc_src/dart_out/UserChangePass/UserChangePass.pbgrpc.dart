...
library UserChangePass_UserChangePass_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'UserChangePass.pb.dart';
export 'UserChangePass.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/UserChangePass.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'UserChangePass.RpcYCall';
