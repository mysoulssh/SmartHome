...
library ProductCmdAdd_ProductCmdAdd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'ProductCmdAdd.pb.dart';
export 'ProductCmdAdd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/ProductCmdAdd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'ProductCmdAdd.RpcYCall';
