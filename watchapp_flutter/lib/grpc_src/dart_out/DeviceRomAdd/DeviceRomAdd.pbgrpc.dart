...
library DeviceRomAdd_DeviceRomAdd_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceRomAdd.pb.dart';
export 'DeviceRomAdd.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceRomAdd.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceRomAdd.RpcYCall';
