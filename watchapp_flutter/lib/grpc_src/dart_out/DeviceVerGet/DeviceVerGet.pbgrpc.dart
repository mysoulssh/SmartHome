...
library DeviceVerGet_DeviceVerGet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'DeviceVerGet.pb.dart';
export 'DeviceVerGet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/DeviceVerGet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'DeviceVerGet.RpcYCall';
