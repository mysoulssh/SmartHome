...
library EventRuleSet_EventRuleSet_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'EventRuleSet.pb.dart';
export 'EventRuleSet.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/EventRuleSet.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'EventRuleSet.RpcYCall';
