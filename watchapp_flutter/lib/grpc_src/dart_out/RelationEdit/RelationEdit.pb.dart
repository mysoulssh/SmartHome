...
library RelationEdit_RelationEdit;
...
class RpcRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RpcRequest')
    ...
    ..a<String>(21, 'relationDesc', PbFieldType.OS)
  ...
  String get relationDesc => $_get(2, 21, '');
  set relationDesc(String v) { $_setString(2, 21, v); }
  bool hasRelationDesc() => $_has(2, 21);
  void clearRelationDesc() => clearField(21);
}
