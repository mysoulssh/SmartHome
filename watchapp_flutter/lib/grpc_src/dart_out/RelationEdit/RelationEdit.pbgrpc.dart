...
library RelationEdit_RelationEdit_pbgrpc;

import 'dart:async';

import 'package:grpc/grpc.dart';

import 'RelationEdit.pb.dart';
export 'RelationEdit.pb.dart';

class RpcYCallClient extends Client {
  static final _$yCall = new ClientMethod<RpcRequest, RpcResponse>(
      '/RelationEdit.RpcYCall/YCall',
...
abstract class RpcYCallServiceBase extends Service {
  String get $name => 'RelationEdit.RpcYCall';
